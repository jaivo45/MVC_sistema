...
public class Controller_Proveedor implements ActionListener {
    ...
    public Controller_Proveedor(Main.Model_Proveedor suppliersModel, View_Proveedor suppliersView) {
    ...
    public void agregarProveedor() { 
        ...
        Model_Proveedor.agregarProveedor(nombre, ap_paterno, ap_materno, telefono, email, rfc, calle, numero, colonia, ciudad, estado);
       Model_Proveedor.setValues();
        showValues();
    }
    ...
    public void modificarProveedor() {
        ...
        String ciudad = View_Proveedor.jtf_ciudad.getText();
        String estado = View_Proveedor.jtf_estado.getText();
        Model_Proveedor.modificarProveedor(nombre, ap_paterno, ap_materno, telefono, email, rfc, calle, numero, colonia, ciudad, estado);
        Model_Proveedor.setValues();
        showValues();
    }
    ...
    public void buscarProveedor() {
        ...
        if(name.equals( View_Proveedor.jtf_nombre.getText()))
            JOptionPane.showMessageDialog(null, name + " tu registro existe en la base de datos", "Resultados", JOptionPane.INFORMATION_MESSAGE);
        else 
            JOptionPane.showMessageDialog(null, name + " tu registro no existe en la base de datos. Intente de nuevo", "Alerta", JOptionPane.ERROR_MESSAGE);
    }
    
    public void registros() {
         View_Proveedor.jT_id_Proveedor.equals(Model_Proveedor.tableModel);

...
public class Model_Proveedor {
 private Connection conexion;
   ...
   public void modificarProveedor(String nombre, String ap_paterno, String ap_materno, String telefono, String email, String rfc, String calle, int numero, String colonia, String ciudad, String estado) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public String gettelefono() {
     ...
     public void Registro() {
        try {
            ...
            st.executeUpdate("Insert into proveedor (nombre,ap_paterno,ap_materno,telefono, email, rfc ,calle,numero,colonia,ciudad,estado)" + " values ('" + id_proveedor + "','" + nombre + "','" + ap_paterno + "','" + ap_materno + "','" + telefono + email + "','" + rfc + "','" + calle + "','" + numero + "','" + colonia +  ciudad + "','" + estado +"')");
